...
function checkInfluencerObject(influencer) {
  ...
  const { first_name, last_name, birth_date, email, description, iban } =
    influencer;
...
function checkPaymentObject(payment) {
  ...
  let checkedPayment = {
    influencer_id: checkIfNumber(influencer_id),
    brand_id: checkIfNumber(brand_id),
...
module.exports = {
  ...
  checkPaymentObject: checkPaymentObject,
  checkBrandObject: checkBrandObject,
};
